...
class GroupController extends Controller
{
    public function getGroupPopulation(Request $request)
    {
        ...
        ->selectRaw('groups.*, SUM(IF(group_title = "Old", 1, 0)) as olds, SUM(IF(group_title = "Young", 1, 0)) as Youngs, SUM(IF(group_title = "Child", 1, 0)) as Childs, SUM(population) as totalpopulation')
        ->groupBy('groups.id')
        ->get();
