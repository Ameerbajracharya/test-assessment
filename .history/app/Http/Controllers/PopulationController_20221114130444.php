...
class PopulationController extends Controller
{
    ...
    {
        $countries = Country::orderBy('country_name', 'asc')->pluck('countrry_name', 'id');
        $cities = City::orderBy('city_name', 'asc')->pluck('city_name');
        $genders = Gender::orderBy('gender_title', 'asc')->get();
