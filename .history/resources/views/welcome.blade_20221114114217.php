                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <select name="city" id="city" class="form-select">
                                ...
                                <option value="{{ $city->id }}">{{ ucfirst($city->city_name) }}( {{ number_format($city->population, 3, ',') }} )</option>
                                @empty
                        ...
                        <div class="col-md-4">
                            <select name="gender" class="form-select">
                                ...
                                <option value="{{ $gender->id }}">{{ ucfirst($gender->gender_title) }}( {{ number_format($city->population, 3, ',') }} )</option>
                                @empty
