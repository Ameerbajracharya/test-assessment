                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <select name="country" id="country" class="form-select">
                                <option value="">All Countries({{ number_format($total_population, 0, ',') }})</option>
                                @forelse ($countries_list as $country)
                                <option value="{{ $country->id }}">{{ ucfirst($country->country_name) }}( {{ number_format($country->population, 0, ',') }} )</option>
                                @empty
                        ...
                        <div class="col-md-4">
                            <select name="city" id="city" class="form-select">
                                ...
                                <option value="{{ $city->id }}">{{ ucfirst($city->city_name) }}( {{ number_format($city->population_sum_population, 0, ',') }} )</option>
                                @empty
                        ...
                        <div class="col-md-4">
                            <select name="gender" id="gender" class="form-select">
                                ...
                                <option value="{{ $gender->id }}">{{ ucfirst($gender->gender_title) }}( {{ number_format($gender->population, 0, ',') }} )</option>
                                @empty
