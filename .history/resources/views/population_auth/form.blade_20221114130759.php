                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                {{ Form::select('gender_id', $genders, isset($population) ? $population->gender_id : null,
                                    [
                                        'class'=>'form-control select2',
                                        'id' => 'gender',
                            ...
                            {{-- Select group --}}
                            <div class="form-group col-md-12">
                                <label class="form-label">SelectGroup <span class="text-danger">*</span></label>
                                {{ Form::select('group_id', $groups, isset($population) ? $population->group_id : null,
                                    [
                                        'class'=>'form-control select2',
                                        'id' => 'group',
